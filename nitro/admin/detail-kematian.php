...
<head>
    ...
    <?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = $conn->query("SELECT * from data_penduduk, data_kematian where asal = 'asli' and ket = 'mati' and id_kematian='$_GET[kd]'");
                    ...
                    <tr>
                    <td width="250">ID penduduk</td>
                    <td width="550"><?php echo $data['id_penduduk']; ?></td>
                    </tr>
                    <tr>
                    <td>Nama</td>
