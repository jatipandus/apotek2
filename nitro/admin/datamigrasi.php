...
<?php } ?>
                ...
                <section class="content">
                  ...
                  <center><h4>Jumlah Migrasi : <?php echo $no; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                 <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="cetak laporan" href="laporan-migrasi.php"><span class="glyphicon glyphicon-print"></span>&nbspLaporan</a><br><br> 
