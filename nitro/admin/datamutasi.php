                ...
                <section class="content">
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Alamat Mutasi </center></th>
                      </tr>
                  </thead>
                    ...
                    <td>RT/RW <?php echo $data['rtrw_mutasi']?>, Desa <?php echo $data['desa_mutasi']?>, Kecamatan <?php echo $data['kecamatan_mutasi']?>, Kabupaten <?php echo $data['kabupaten_mutasi']?></td>
                  ...
                  <center><h4>Jumlah Mutasi : <?php echo $no; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                    <a class="btn btn-sm btn-success" data-placement="bottom" data-toggle="tooltip" title="cetak laporan" href="laporan-mutasi.php"><span class="glyphicon glyphicon-print"></span> Laporan</a><br><br> 
                 <!-- <a href="input-migrasi.php" class="btn btn-sm btn-primary">Tambah Migrasi <i class="fa fa-arrow-circle-down"></i></a>  -->
                 <a href="input-mutasi.php" class="btn btn-sm btn-primary">Tambah data mutasi <i class="fa fa-arrow-circle-down"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
