 ...
 <b>Data Kelahiran</b>
              ...
              ?>
                 ...
                 <?php $tampil=$conn->query("SELECT * from data_penduduk where ket='hidup' and asal='asli' ");
                  ...
                  <center><h4>Jumlah Kelahiran : <?php echo "$user"; ?> Orang </h4> </center>

                <div class="text-right" style="margin-top: 10px;">
                 <a href="laporan-kelahiran.php" class="btn btn-sm btn-success" ><span class="glyphicon glyphicon-print">  Laporan</a><br><br>
                 <a href="input-kelahiran.php" class="btn btn-sm btn-primary">Tambah data kelahiran <i class="fa fa-arrow-circle-down"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
