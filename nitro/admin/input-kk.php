                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="status_hubungankeluarga" class="form-control" id="status_hubungankeluarga" type="text" value="Kepala keluarga" readonly />
                              </div>
                          </div>
                           <div class="form-group">
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
	                              ...
	                              <a href="input-kk.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
