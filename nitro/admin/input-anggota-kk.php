                ...
                <section class="content">
                    ...
                    <div class="row">
                     ...
                     <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="no_kk" type="text" id="no_kk" class="form-control" readonly="readonly" value="<?php echo $_GET['kd']; ?>" required />
                         ...
                         <div class="form-group">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                  <select class="form-control" name="status_hubungankeluarga" id="status_hubungankeluarga">
                                  <option> -- Pilih Salah Satu --</option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-8">
                                  <input name="ibu" class="form-control" id="bu" type="text" placeholder="Nama Ibu" required />
                              </div>
                          </div> 
                          ...
                          <div class="form-group" style="margin-bottom: 20px;">
                              ...
                              <div class="col-sm-8">
                                ...
                                <a href="input-anggota-kk.php" class="btn btn-sm btn-danger">Batal </a>
                              </div>
                          </div>
