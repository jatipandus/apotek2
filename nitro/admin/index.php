                        ...
                        <div class="col-md-8">
                            ...
                            <section class="panel">
                                <header class="panel-heading">
                                    ...
                                    <?php 
                                    $query1="SELECT nik,nama,tgl_lahir, YEAR(curdate()) - YEAR(tgl_lahir) AS usia from data_penduduk where asal = 'asli' and ket = 'hidup' order by id desc limit 7;";
        ...
        $birthDt = new DateTime($data['tgl_lahir']);
              ...
              <!-- row end -->
                ...
                <div class="footer-main">
                    Copyright &copy <a href="http://www.facebook/ngihiy.com" target="_blank">Newbiee.IT</a> 2017
                </div>
            </aside><!-- /.right-side -->
