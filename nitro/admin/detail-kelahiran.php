...
<head>
    ...
    <?php } ?>
                ...
                <div class="text-right">
                     ...
                     <a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Hapus data" href="hapus-kelahiran.php?kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></a><br><br>
