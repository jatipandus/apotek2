...
include "../conn.php";
  ...
  $sql2=$conn->query("UPDATE data_migrasi set id_migrasi='$id_migrasi',nik='$nik',nama='$nama',
    ...
    kabupaten_domisili='$kabupaten_asal',tgl_masuk='$tgl_masuk',rtrw_domisili='$rtrw_domisili',
    desa_domisili='$desa_domisili',kecamatan_domisili='$kecamatan_domisili',kabupaten_domisili='$kabupaten_domisili' where id_migrasi='s$id_migrasi'");
