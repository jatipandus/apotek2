...
<head>
    ...
    <?php } ?>
                ...
                <section class="content">
                    ...
                    <?php
                    $query = $conn->query("SELECT * FROM data_penduduk WHERE id='$_GET[kd]'");
                ...
                href="edit-penduduk.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-edit"></span></a>

                <a class="btn btn-sm btn-danger" data-placement="bottom" data-toggle="tooltip" title="Hapus data" 
                href="hapus-penduduk.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="glyphicon glyphicon-trash"></a><br><br>
