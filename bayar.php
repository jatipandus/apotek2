...
<?php 
$query = $conn->query("SELECT * FROM pesanan order by id_pesanan DESC LIMIT 1");
		...
		<div id="fh5co-main">
			<div class="fh5co-narrow-content">
				<div class="row animate-box" data-animate-effect="fadeInLeft"> 	
					...
					<div>
						<form action="insert-pesanan.php" method="POST" enctype="multipart/form-data" >
					<div class="row">
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" class="form-control" name="nama_customer" id="nama_customer" placeholder="Nama Lengkap">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<center>
											<input type="submit" class="btn btn-primary btn-md" value="Pesan">
