		...
		<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
			...
			<nav id="fh5co-main-menu" role="navigation">
				<ul>
					...
					<li><a href="daftarobatcustomer.php">Daftar Obat</a></li>
		...
		<div class="fh5co-narrow-content  animate-box" data-animate-effect="fadeInLeft">
				...
				<div class="row">
					<div class="col-md-4 fh5co-staff">
						<img src="gambar/pandu.jpg" alt="Free HTML5 Bootstrap Template" width="250" height="300">
						<h3>Jati Pandu Saputra</h3>
						<h4>Programmer</h4>
						<p>Udah Semester 5, Bentar lagi luluuuussss.....</p>
					...
					<div class="col-md-4 fh5co-staff">
						<img src="gambar/agung.jpg" alt="Free HTML5 Bootstrap Template" width="250" height="300">
						<h3>Maulana Agung Pribadi</h3>
						<h4>Designer</h4>
						<p>Makan bang, jangan lupa minum</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
					...
					<div class="col-md-4 fh5co-staff">
						<img src="gambar/yogi.jpg" alt="Free HTML5 Bootstrap Template" width="250" height="300">
						<h3>Yogi Handika</h3>
						<h4>Analysis</h4>
