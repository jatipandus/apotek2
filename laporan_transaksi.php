...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<div id="fh5co-page">
        ...
        <div class="title" class="animate-box" data-animate-effect="fadeInLeft"><h2><center><br>Laporan Penjualan</center></h2></div>
			...
			</table><br><center><a href="cetak_laporan.php" target="_blank"><button class="btn btn-primary btn-md">Cetak Laporan</button></a><a href="fpdf/cetak.php" target="_blank"><button class="btn btn-primary btn-md">Cetak PDF</button></a></center>
            <center></center>
		<div class="clear"></div>
	</div>
</div>
